...
class MERLIN():
    ...
    def __init__(self,
        ...
        if data_type == 'text':
            self.data_manager = {
                'left': TextDataManager(X_t1, predicted_labels_t1, 'left'),
                'right': TextDataManager(X_t2, predicted_labels_t2, 'right'),
            }
        else:
            self.data_manager = {
                'left': TabularDataManager(X_t1, predicted_labels_t1, 'left'),
                'right': TabularDataManager(X_t2, predicted_labels_t2, 'right'),
            }
